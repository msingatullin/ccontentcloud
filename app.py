...
# from app.api.social_media_ns import social_media_ns  # Не используем - используем Blueprint
...
def create_app():
    ...
    # social_media_ns не добавляем - используем обычный Blueprint который уже работает
