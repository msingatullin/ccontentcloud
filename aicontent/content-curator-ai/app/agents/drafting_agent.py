...
3. Призыв к действию (1 предложение)""",
                max_tokens=200,
                temperature=0.7,
                system_message="Ты профессиональный копирайтер, специализирующийся на создании контента для социальных сетей. Создавай увлекательный и информативный контент.",
                examples=[
...
3. Призыв к обсуждению""",
                max_tokens=150,
                temperature=0.8,
                system_message="Ты создаешь контент для VK - социальной сети с живым общением. Пиши в разговорном стиле, задавай вопросы.",
                examples=[
...
3. Хештеги""",
                max_tokens=100,
                temperature=0.9,
                system_message="Ты создаешь контент для Instagram - визуальной платформы. Используй эмодзи, создавай атмосферу.",
                examples=[
...
3. Хештеги""",
                max_tokens=100,
                temperature=0.8,
                system_message="Ты создаешь твиты - короткие, остроумные сообщения. Будь лаконичным и запоминающимся.",
                examples=[
                    "💡 Идея дня:",
                    "🔥 Горячая тема:",
                    "⚡ Быстрый факт:"
