...
class AuthMe(Resource):
    ...
    def get(self, current_user):
        ...
        try:
            ...
            # Получить данные пользователя из USERS_STORAGE
...
class AuthProfile(Resource):
    ...
    def put(self, current_user):
        ...
        try:
            ...
            # Обновить данные пользователя в USERS_STORAGE
            if email in USERS_STORAGE:
...
class AuthChangePassword(Resource):
    ...
    def post(self, current_user):
        ...
        try:
            ...
            # Получаем пользователя из USERS_STORAGE
            ...
            # Обновляем пароль
            user_data['password_hash'] = generate_password_hash(data['new_password'])
            USERS_STORAGE[email] = user_data
