...
Требования:
- Захватывающая зацепка в начале, основанная на реальной теме из описания
- Информативный основной контент, который РАСКРЫВАЕТ тему из описания полностью - используй ключевые моменты из описания
- Призыв к действию в конце
- Используй эмодзи для привлечения внимания (умеренно, 2-3 эмодзи)
- Длина: до 1500 символов, но пост должен быть ЗАВЕРШЕННЫМ и информативным
- НЕ добавляй блоки "Похожие события", "Similar events", исторические данные или события за последние годы
- НЕ используй шаблонные фразы - создавай уникальный контент на основе описания
- НЕ обрывай пост на полуслове - обязательно заверши мысль

Структура:
1. Зацепка (1-2 предложения) - на основе реальной темы из описания
2. Основной контент (10-15 предложений) - РАСКРОЙ тему из описания полностью, используй информацию из описания, создай развернутый и детальный контент
3. Призыв к действию (1 предложение)""",
                ...
                temperature=0.7,
                system_message="Ты профессиональный копирайтер, специализирующийся на создании контента для социальных сетей. Создавай увлекательный и информативный контент на основе предоставленного описания. НЕ добавляй блоки с похожими событиями, историческими данными или событиями за последние годы. НЕ используй шаблонные фразы. Используй информацию из детального описания для создания уникального контента.",
                examples=[
