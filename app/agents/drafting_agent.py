...
Теперь создай пост на тему: {topic}""",
                max_tokens=250,
                temperature=0.8,
                system_message="Ты умный друг, который делится полезными лайфхаками. Пишешь плотно, понятно, человечно. Никаких корпоративных шаблонов и воды. Только конкретная польза в каждом предложении.",
                examples=[
