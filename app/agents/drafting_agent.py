...
- Длина: до 500 символов, но пост должен быть ЗАВЕРШЕННЫМ и информативным
...
2. Основной контент (3-5 предложений) - РАСКРОЙ тему из описания полностью, используй информацию из описания
3. Призыв к действию (1 предложение)""",
                max_tokens=600,  # Увеличено для полноценного поста (500 символов требует ~400-500 токенов)
                temperature=0.7,
