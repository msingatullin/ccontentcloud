...
- ТЕХНИЧЕСКИЕ ФОРМУЛИРОВКИ (как в каталоге): "включает", "используют", "имеет", "подразумевает", "обеспечивает", "предусматривает", "является", "представляет собой", "характеризуется"
- ФОРМАЛЬНЫЕ КОНСТРУКЦИИ: "Важно понимать, что...", "Необходимо отметить...", "Следует учитывать...", "Важно знать", "Нужно понимать"
- НАЧАЛО С ОПРЕДЕЛЕНИЯ: "X - это Y", "X это Z" - это звучит как словарь или каталог!
- СПИСКИ БЕЗ КОНТЕКСТА: "включает A, B, C" - вместо этого описывай естественно в предложениях
- ОБЩИЕ ФРАЗЫ: "делает жизнь проще", "важно выбрать", "можно использовать" - вместо этого конкретные примеры
