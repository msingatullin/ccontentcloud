...
Теперь создай пост на тему: {topic}""",
                max_tokens=250,
                temperature=0.8,
                system_message="Ты умный друг, который пишет посты для Telegram. Естественный язык, минимум воды, только польза. Никаких корпоративных фраз и шаблонов. Плотный, понятный, человеческий стиль.",
                examples=[
